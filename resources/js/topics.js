var faq = [ {
  ...
  items: [{
    ...
    text: `<ul>
            ...
            <li>$hosky.rugpool - send 2 ada here to claim staking rewards</li>
  ...
  items: [{
    ...
    text: `<p>
              Every epoch, hosky is distributed to idjiots that are staked with partnered rugpools.
              The hosky tokens that are distrbuted is divided amongst the rug pools and put in 2 different "buckets", one for the 
              ada staked and one for the C(ash Grab) NFT's staked(except for WRFGS, which is ADA only).
          </p>`
  }
  // , {
  //   keywords: "stakecg",
  //   title: "Stake C(ash grab) NFT to a Rug Pool",
  //   text: `<p>Yes, you can get worthless tokens with your jpgs. It is a complicated game, but some community members have made tools to
  ...
  items: [{
    ...
    text: `<p>
           ...
           <p>
              Should WAN, Rosenbridge, etc. be discussed here?
           </p>`
  }, {
    keywords: "cexes",
    title: "NYK/NYC",
    text: `Hosky Token is currently available on three centralized exhanges. Bitmar has been announce but is not yet live and there are two more yet to be named that are in the works.
          <ul>
            <li>MEXC</li>
            <li>Coinstore</li>
            <li>Bitmart</li>
    ...
    text: `If having hosky tokens isn't degen enough for you and you really want to dress to unimpress, there is a
  ...
  items: [{
    keywords: "wen",
    title: "Website",
    text: `Coming thoon for 84 years, the latest rumor is it will launch in 2069
    and offer live ada/cg statistics for the rugpools`
  }, {
    keywords: "wen",
    title: "10K",
    text: `The "proper" 10k NFT collection that will supposedly be given to C(ash Grab) NFT holders. The snapshot has already been
           done, so you can only watch pool.pm anxiously and head to jpg.store when you see them mint.`
  },{
    keywords: "wen",
    title: "Radioactive Purpose",
    text: `Prolly Hosky was just trolling, but these "have purpose".......latest rumor is they may interact with the 10k collection.`
  },{
    keywords: "wen",
    title: "Mystery Accessory Reveal",
    text: `These have already been distributed at in-person events using the "Proof of Onbarding" protocol
  ...
  items: [{
    ...
    text: `<p>Once you receive that sweet sweet rain in the discord, you will immediately wonder where are the tokens.
